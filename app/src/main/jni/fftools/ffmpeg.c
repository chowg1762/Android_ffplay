...
// function 명은 com_prompt_veaver_NDK.h 파일을 참고하셔서 만드시면 됩니다.

JNIEXPORT jint JNICALL Java_tutorial_ffmpeg_tutorial_NDKAdapter_run_1ffmpeg(JNIEnv *env, jobject obj)

{
    ...
    char* a0 = "ffmpeg";
    char* a1 = "-i";
    char* a2 = "/storage/emulated/0/DCIM/Camera/20180623_160733.mp4";
    char* a3 = "-filter:v";
    char* a4 = "crop=300:400:10:20";
    char* a5 = "/storage/emulated/0/DCIM/Camera/output.mp4";
